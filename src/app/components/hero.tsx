...
export default function Hero() {
  return (
      <motion.section
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="px-2 relative bg-fixed h-[600px] bg-hero bg-no-repeat bg-cover bg-center"
      >
        <div className="pt-[4.5rem] flex items-center justify-center h-full md:justify-end md:w-full">
          <motion.h1
